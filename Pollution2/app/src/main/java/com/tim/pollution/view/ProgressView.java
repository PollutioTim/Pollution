package com.tim.pollution.view;
...
public class ProgressView extends View {
    ...
    private int prograssColor=Color.RED;
     ...
     * @param color #ffffff
     */
    public void setPrograssColor(String color){
        this.prograssColor=Color.parseColor(color);
        invalidate();
    }
    /***
     * 设置最大的进度值
